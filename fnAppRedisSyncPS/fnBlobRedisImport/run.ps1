...
Import-AzRedisEnterpriseCache -Name $env:DEST_CLUSTER_NAME -ResourceGroupName $rgname -SasUri "https://$env:DEST_STORAGE_NAME.blob.core.windows.net/$env:DEST_CONTAINER/$filename$token;$src_key"
